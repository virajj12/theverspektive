...
export default function FloatingSocials() {
  ...
  return (
    <div className="fixed bottom-0 left-0 z-50 p-6 md:p-8 flex flex-col gap-4 items-center text-black drop-shadow-[0_4px_12px_rgba(0,0,0,0.15)] dark:text-white dark:drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)]">
