...
export default function G3BuildersClient({ teams = [] }: { teams?: any[] }) {
  return (
    <div className="flex flex-col min-h-screen pt-24 bg-background items-center justify-center">
      <div className="container mx-auto px-6 md:px-12 py-12 md:py-24 max-w-[1200px] text-center">
        
        <MaskText text="VerspeKtive" className="text-4xl md:text-6xl font-bold tracking-tight mb-8 justify-center" />
        
        <div className="max-w-[800px] mx-auto bg-zinc-100 dark:bg-zinc-900 rounded-[32px] p-12 md:p-24 border border-zinc-200 dark:border-white/10 mb-12 shadow-xl shadow-black/5 dark:shadow-none">
          <MaskText text="Coming Soon" className="text-3xl font-semibold mb-6 justify-center" />
          <MaskText 
            text="This page is currently under construction. Reach out to us for any inquiries regarding G3 Builders and Architecture."
        ...
        <Link href="/" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground font-medium transition-colors mb-32">
